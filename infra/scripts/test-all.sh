...
fail=0
for f in libs/money/src/money.test.ts libs/auth/src/abilities.test.ts libs/maps/src/maps.test.ts apps/svc-identity/test/otp.spec.ts apps/svc-pricing/test/pricing.spec.ts; do
  echo "── $f"
  out=$(npx tsx "$f" 2>&1)
