...
class BesoncEnvironment {
  const BesoncEnvironment({
  ...
  factory BesoncEnvironment.fromDefines() {
    ...
    return const BesoncEnvironment(apiBaseUrl: api, wsBaseUrl: ws, name: name);
  }
}
